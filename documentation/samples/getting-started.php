...
<?php modalImageDialog("/tea/documentation/images/01-Main.png", "Headless TEA product settings"); ?>
<?php modalImageDialog("/tea/documentation/images/01-Arguments.png", "Headless TEA argument settings"); ?>
		...
		<div class="row">
			<div class="span12">
				<p>
					...
					<ul>
					<li>The Target Platform needs to be set to an Eclipse installation with TEA available. The most simple case is the running Eclipse with TEA installed (see <a href="/tea/download.php">here</a>).</li>
		...
		<div class="row">
			...
			<div class="span3">
				<span class="pull-right">
					<?php imageThumb("/tea/documentation/images/01-Main.png", "Headless TEA product settings"); ?>
					<?php imageThumb("/tea/documentation/images/01-Arguments.png", "Headless TEA argument settings"); ?>
				</span>
			</div>
		</div>
	</div>
